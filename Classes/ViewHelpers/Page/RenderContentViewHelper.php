 ...
 * @package Fed, Typo3Theme
 * @subpackage ViewHelpers/Page
 */
class Tx_Typo3Theme_ViewHelpers_Page_RenderContentViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	protected function getContentRecords() {
		...
		do {
			...
			if (is_array($contentUids)) {
				...
				$conditions = "pid = '" . $pid ."' AND colPos = '" . $colPos . "' " . $GLOBALS['TSFE']->cObj->enableFields('tt_content') . " AND (sys_language_uid IN (-1,0) OR (sys_language_uid = '" . $GLOBALS['TSFE']->sys_language_uid . "' AND l18n_parent = '0'))";
			}
