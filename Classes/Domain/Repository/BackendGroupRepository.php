 ...
 *
 */
class BackendGroupRepository extends AbstractBaseRepository {


    /**
     * Get Groups that match certain identifier
     * @param string $identifier
     *
     * @return QueryResult
     * @codeCoverageIgnore
     */
    public function findAllGroupsWithMatchingIdentifier($identifier) {
