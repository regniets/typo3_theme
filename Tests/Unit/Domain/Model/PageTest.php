 ...
 *
 */
class PageTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	public function setUp(){
		$this->fixture = new \TechDivision\Typo3Theme\Domain\Model\Page;
	 ...
	 * 
	 */
	public function testGetIsRootpageReturnsTrueIfPageIsRootpage(){
		$this->fixture->setIsRootPage(TRUE);

		$this->assertSame(
			TRUE,
			$this->fixture->getIsRootPage()
		);
	 ...
	 * 
	 */
	public function testGetIsRootpageReturnsFalseIfPageIsNotARootpage(){
		$this->fixture->setIsRootPage(FALSE);
